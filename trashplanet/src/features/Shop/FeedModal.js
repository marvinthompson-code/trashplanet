  ...
  <div className="modal-dialog modal-dialog-centered" role="document">
    <div className="modal-content text-center">
      <div className="modal-header text-center">
        <h5 className="modal-title" id="exampleModalLongTitle" className="shopCardTitle">SHOP THE FEED</h5>
      ...
      <div className="modal-footer">
        <button type="button" className="btn btn-secondary bannerButton" data-dismiss="modal">Close</button>
      </div>
    </div>
  </div>
</div>
